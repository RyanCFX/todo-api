...
/**
 * GUARDIA QUE VERIFICA LA AUTENTICACIÓN DEL USUARIO MEDIANTE UN TOKEN JWT.
 * ESTA GUARDIA DEBE UTILIZARSE EN RUTAS QUE REQUIERAN AUTENTICACIÓN.
 */
@Injectable()
export class JwtAuthGuard implements CanActivate {
  ...
  /**
   * DETERMINA SI LA SOLICITUD TIENE PERMISO PARA PROCEDER BASADO EN EL TOKEN Y EL ID DEL USUARIO.
